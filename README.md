...
เว็บแอปจัดงาน Wine Tasting — ฝั่ง User ลงทะเบียนเข้าร่วมงานพร้อมแนบสลิปโอนเงิน และฝั่ง Admin ตรวจสลิป จัดการรายการลงทะเบียน ผู้ใช้งาน ประกาศ และสร้างแบบฟอร์มลงทะเบียนแบบ dynamic พร้อมรายงาน/พิมพ์และ export Excel
...
**ฝั่ง User**
- หน้าหลัก: banner carousel (auto-play/dots/lightbox), ประกาศ, ปุ่มลงทะเบียน
- แบบฟอร์มลงทะเบียนแบบ dynamic ตามที่ Admin ตั้งค่า พร้อม QR ชำระเงิน (view-only + ดาวน์โหลด) และแนบสลิป
- เลขที่อ้างอิงรูปแบบ `[ปีพ.ศ.]-[เลขลำดับ]`
- สลับภาษา TH/EN
...
- ประกาศ: ข้อความ TH/EN, รูป banner หลายภาพ, ขนาด banner, ช่วงวันที่แสดงผล
